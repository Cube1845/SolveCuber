...
internal class EdgePosition
{
    ...
    // if the edge is not on top layer, FirstColor represents color located on the front face of the cube,
    // when the edge is on the right side of the cube. To check other edges use only E moves.
    public CubeColor FirstColor { get; set; }

    // If the edge is on top layer, SecondColor represents color on the side face of the cube,
    // if the edge is not on top layer, FirstColor represents color located on the front face of the cube,
    // when the edge is on the left side of the cube. To check other edges use only E moves.
