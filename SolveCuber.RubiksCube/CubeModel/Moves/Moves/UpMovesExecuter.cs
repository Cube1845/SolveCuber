...
namespace SolveCuber.CubeModel.Moves.Moves;

internal static class UpMovesExecuter
{
    public static Cube ExecuteUpMove(Cube cube)
    {
        Cube cubeImage = cube.GetNewInstance();

        cubeImage.Up.RotateClockwise();

        cubeImage.Front.Face[0, 0] = cube.Right.Face[0, 0];
        cubeImage.Front.Face[0, 1] = cube.Right.Face[0, 1];
        cubeImage.Front.Face[0, 2] = cube.Right.Face[0, 2];

        cubeImage.Right.Face[0, 0] = cube.Back.Face[0, 0];
        cubeImage.Right.Face[0, 1] = cube.Back.Face[0, 1];
        cubeImage.Right.Face[0, 2] = cube.Back.Face[0, 2];

        cubeImage.Back.Face[0, 0] = cube.Left.Face[0, 0];
        cubeImage.Back.Face[0, 1] = cube.Left.Face[0, 1];
        cubeImage.Back.Face[0, 2] = cube.Left.Face[0, 2];

        cubeImage.Left.Face[0, 0] = cube.Front.Face[0, 0];
        cubeImage.Left.Face[0, 1] = cube.Front.Face[0, 1];
        cubeImage.Left.Face[0, 2] = cube.Front.Face[0, 2];
